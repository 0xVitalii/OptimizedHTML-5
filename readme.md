...
<pre>git clone https://github.com/gaunter-odm/oh5.git .; rm -rf trunk .gitignore readme.md .git; npm i</pre>
OR
<pre>git clone git@github.com:gaunter-odm/oh5.git .; rm -rf trunk .gitignore readme.md .git; npm i</pre>
